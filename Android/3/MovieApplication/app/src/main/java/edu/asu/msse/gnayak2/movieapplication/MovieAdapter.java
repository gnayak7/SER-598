...
public class MovieAdapter extends BaseExpandableListAdapter  {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        String released = movieLibrary.getMovieReleasedDate(movie);
        String genre = movieLibrary.getMovieGenre(movie);
        ...
        TextView textViewReleased = (TextView) convertView.findViewById(R.id.movie_title_released);
        textViewReleased.setText(released);
        TextView textViewGenre = (TextView) convertView.findViewById(R.id.movie_title_genre);
