 ...
 *
 * Purpose: The purpose of this class is to fetch JSON data asynchronously
...
public class AsyncCollectionConnect extends AsyncTask<MethodInformation, Integer, MethodInformation> {
    ...
    public String buildMethod(JSONArray ja, MethodInformation... aRequest) {
        String request = "{ \"jsonrpc\":\"2.0\", \"method\":\""+aRequest[0].method+"\", \"params\":"+ja.toString()+",\"id\":"+ MovieConstants.REQUEST_ID +"}";
        MovieConstants.REQUEST_ID++;
        return request;
    }
