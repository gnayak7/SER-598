...
public class Movie implements Serializable {
     ...
     * @returns Object
     */
    public Movie(String id, String title, String year, String rated, String released, String runtime, String genre, String actors, String plot, String poster, String media) {
        this.id = id;
        this.title = title;
        this.year = year;
        this.rated = rated;
    ...
    /**
     * Constructor for movie coming from RPC server
     *
     * @param jsonString JSON string.
     * @returns Object
     */
    public Movie(String jsonString, boolean fromRPCServer) {
        if (fromRPCServer) {
            try {
                JSONObject jsonObj = new JSONObject(jsonString);
                this.title = jsonObj.getString("Title");
                ...
                this.genre = jsonObj.getString("Genre");
                this.poster = jsonObj.getString("Poster");
                this.media = jsonObj.getString("Filename");
                this.id = UniqueIDGenerator.getUniqueId();
                Log.w(this.getClass().getSimpleName(), "Successfully extracted all the information from JSON String");
            } catch (JSONException e) {
                Log.w("Json String: ", jsonString);
                Log.w(this.getClass().getSimpleName(), "Error extracting the information from JSON String");
            }
